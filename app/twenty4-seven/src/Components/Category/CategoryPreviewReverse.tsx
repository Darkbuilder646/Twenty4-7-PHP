  ...
  return (
    <div className="flex my-8">
      <div
        id="img"
        style={divStyle}
        className="flex h-72 w-2/6 mr-28 bg-light_bg dark:bg-[#D9D9D9] border-4 border-light_border dark:border-dark_border rounded-xl items-center justify-center"
      >
        <img
          src={imgPath}
          alt={categoryName}
